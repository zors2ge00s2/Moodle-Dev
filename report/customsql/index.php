...
foreach ($categories as $category) {
    ...
    echo html_writer::end_tag('div');
    echo "<a href=\"/lib/duration.php\" class=\"btn btn-primary image-button\" style=\" background: #51666c url('/pix/a/download_all.png') no-repeat right;
    padding-right: 2rem; width: 31rem;                           background-size:1.9rem;  text-align:left;               
    height: 3rem;\">Percentage of videos watched</a> <br><br>";
}
